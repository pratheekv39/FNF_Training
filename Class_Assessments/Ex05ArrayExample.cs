...
{
    internal class Ex05ArrayExample
    {
...
/*
 * Create a function that creates an array of elements based on the inputs taken from the user . User shall give inputs like size, databytes and elements.
 * The function should return the array and the 
 * 
 * 
 * 
 * 
